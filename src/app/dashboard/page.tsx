        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 pb-2">
          <div className="space-y-2">
            ...
            <Card className="border-accent-primary/20 h-full">
              ...
              <CardContent>
                <div className="space-y-2">
                  <p className="text-sm text-text-secondary">Crea rutinas adaptadas a tus objetivos</p>
            ...
            <Card className="h-full">
              ...
              <CardContent>
                <div className="space-y-2">
                  <p className="text-sm text-text-secondary">Biblioteca completa de ejercicios</p>
                  <ul className="text-xs text-text-tertiary space-y-1">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-xs font-medium text-text-primary">Explora ejercicios disponibles</p>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-xs font-medium text-text-primary">Crea tu primera rutina</p>
                      <p className="text-xs text-text-tertiary">Personaliza según tus objetivos</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="w-5 h-5 rounded-full bg-accent-primary/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <div>
                      <p className="text-xs font-medium text-text-primary">Comienza a entrenar</p>
