          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <Button
              ...
              onClick={() =>
                updateFilter(
                  'equipment',
                  filters.equipment.includes('bodyweight') ? [] : ['bodyweight']
                )
              }
              className={cn(
                'text-sm',
                filters.equipment.includes('bodyweight') &&
                  'bg-accent-primary/20 border-accent-primary text-accent-primary'
              )}
            >
                    ...
                    >
                      <div
                        className={cn(
                          ...
                          isSelected &&
                            'ring-2 ring-accent-primary ring-offset-2 ring-offset-background-secondary scale-105',
                          !canSelect &&
                            !isSelected &&
      ...
      {selectedExercises.length > 0 && (
        <div className="p-4 border-t border-slate-700 bg-slate-800/50">
          <div className="flex items-center justify-between">
            ...
            {maxSelection && <span className="text-xs text-slate-500">Máximo: {maxSelection}</span>}
          </div>
        </div>
      )}
    </div>
