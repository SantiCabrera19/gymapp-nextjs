                  ...
                  {isEditing ? (
                    <>
                      ...
                      <input
                        ...
                        onChange={e =>
                          setEditData(prev => ({ ...prev, weight_kg: Number(e.target.value) }))
                        }
                      ...
                      <input
                        ...
                        onChange={e =>
                          setEditData(prev => ({ ...prev, reps_completed: Number(e.target.value) }))
                        }
                        className="w-full px-2 py-1 text-sm bg-slate-700 border border-slate-600 rounded text-white text-center"
                        placeholder="Reps"
                      />
            ...
            <div className="grid grid-cols-3 gap-4 text-center text-sm">
              ...
              <div>
                ...
                <div className="font-semibold text-white">
                  {exerciseSets
                    .reduce((total, set) => total + (set.weight_kg || 0) * set.reps_completed, 0)
                    .toFixed(0)}
                  kg
                </div>
              </div>
